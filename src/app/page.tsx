...
// Gradient transitions between sections (alternating black ↔ slate-950)
...
const TransitionFaqToCommunity = () => (
  <div className="h-24 md:h-32 bg-gradient-to-b from-slate-900 to-slate-950" />
);
    ...
    <div className="overflow-x-hidden">
      <WavyBackground className="max-w-6xl mx-auto pb-6 pt-4 px-4">
        <div className="flex flex-col items-center">
          <h1 className="text-3xl md:text-5xl lg:text-7xl text-white font-extrabold inter-var text-center bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent leading-tight">
            KAI Flow
          </h1>
          <h2 className="text-lg md:text-2xl lg:text-3xl text-white/90 font-semibold inter-var text-center mt-2 mb-1">
            Next-Gen AI Workflow Automation
          </h2>
          <p className="text-base md:text-lg mt-3 text-white/80 font-light inter-var text-center max-w-3xl leading-relaxed">
        ...
        <div className="mt-4 flex justify-center flex-1 min-h-0">
          <HeroGallery className="w-full flex justify-center" />
        </div>
      </WavyBackground>
      <Feature108 {...demoData} />
      <TransitionToSlate />
